...
public class ReportGenerationService {
    ...
    public ReportGenerationResponse generateReport(ReportGenerationRequest request, String jwtToken) {
        ...
        try {
            ...
            response.setTotalRecords((int) reportData.getTotalCount());
    ...
    private List<Map<String, Object>> generateSimpleTableDataFromDB(ReportGenerationRequest request) {
        try {
            ...
            System.out.println("🔍 Stage 4: Field masking based on role permissions");
            ...
            System.out.println("✅ 5-stage pipeline completed: Generated " + tableData.size() + " records for " + request.getUserRole());
            return tableData;
    ...
    private List<Map<String, Object>> generateSimpleTableData(List<MaskedTimesheetData> maskedData, ReportGenerationRequest request) {
        ...
        // Get visible fields for this role
        List<String> visibleFields = fieldVisibilityService.getVisibleFields(userRole);
